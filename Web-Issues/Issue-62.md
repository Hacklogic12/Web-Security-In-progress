...
It is common for APIs not not validate parameters provided from user input, and bind them into program code variables without validation.
```
...
- Guess other parameters exist during creation and authentication of a user
